<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bus1.aspx.cs" Inherits="Bus_Start.bus1" %>
       ...
       var busline = new BMap.BusLineSearch(map, {
           ...
           onGetBusListComplete: function (result) {
               if (result) {
                   ...
                   var fstLine = result.getBusListItem(0);//获取第2个公交列表显示到map上
           ...
           onBusLineHtmlSet: function () {
               try {
                   ...
                   getCoordinate(tempVar['0']);//获取反向行驶的名称id 将result.getBusListItem(0)，tempVar['0']中“0”换成“1”
